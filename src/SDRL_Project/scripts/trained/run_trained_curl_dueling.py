...
def run():
    trained_model = get_model(env_name,
                              config_class=CURL_Dueling_Config,
                              model_path=model_path,
                              model_class=CURL_Dueling_Agent)
    env_config = CURL_Dueling_Config()
    ...
    eval_agent(env, trained_model, 5, verbose=True, render=True, max_step=20,
