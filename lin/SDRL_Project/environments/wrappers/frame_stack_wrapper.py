...
class FrameStack(Wrapper, BaseWrapper):
    """
    ...
    def __init__(self, env, num_stack, use_lazy_frame=False, lz4_compress=False):
    ...
    def _get_observation(self):
        ...
        if self.use_lazy_frame:
            return LazyFrames(list(self.frames), self.lz4_compress)
        else:
            obs = np.array(list(self.frames))
            return obs
