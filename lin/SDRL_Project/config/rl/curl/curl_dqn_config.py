...
from learning_agents.data_augmentation.augmentations import random_shift_augmentation, no_augmentation
from learning_agents.data_augmentation.torch_augmentations import Torch_Data_Augmentation, torch_random_shift


class CURL_DQN_Config(Efficient_DQN_Config):
    def __init__(self):
        super(CURL_DQN_Config, self).__init__()

    def get_agent_config(self):
        super(CURL_DQN_Config, self).get_agent_config()
