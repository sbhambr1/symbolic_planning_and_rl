...
from config.rl.curl.curl_dueling_config import CURL_Dueling_Config
from learning_agents.rl.unsupervised.curl.curl_dueling_agent import CURL_Dueling_Agent
...
model_name = 'dueling-curl'


def run():
    expr_config = CURL_Dueling_Config()
    ...
    files_to_save = [os.path.abspath(sys.modules[CURL_Dueling_Agent.__module__].__file__)]
    ...
    # create agent
    dqn_agent = CURL_Dueling_Agent(env, sys_args, policy_hyper_params,
