...
def run():
    ...
    # make sure double q update is turn on
    expr_config.agent_config.policy_hyper_params.use_double_q_update = True
    ...
    # create agent
    dqn_agent = DQN_Agent(env, sys_args, policy_hyper_params,
